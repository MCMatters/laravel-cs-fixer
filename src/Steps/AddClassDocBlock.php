...
use McMatters\CsFixer\NodeVisitor\ClassDocBlockResolver;
 ...
 */
class AddClassDocBlock implements Step
{
    /**
     * @return void
     */
    public function handle(): void
    {
        ...
        foreach ($this->getFiles() as $file) {
            ...
            $traverser->addVisitor($visitor = new ClassDocBlockResolver($content));
            $traverser->traverse($ast);
    ...
    protected function getFiles(): Finder
    {
        return Finder::create()
            ...
            ->name('*.php')
            ->files()
            ->in(Config::get('cs-fixer.class_php_docs.paths'));
    }
}
